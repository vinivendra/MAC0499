...
- (NSString *)camelCase {
    ...
    NSString *joined = [capitalized
                        stringByReplacingOccurrencesOfString:SPACE
                                                  withString:EMPTY_STRING];

    // Edit:
    NSString *lowercase = joined.lowercaseString;
    NSRange firstCharacterRange = {0, 1};
    NSString *firstCharacterString = [lowercase
                                      substringWithRange:firstCharacterRange];
    return [joined stringByReplacingCharactersInRange:firstCharacterRange
                                         withString:firstCharacterString];
    //
}

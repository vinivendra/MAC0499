...
let _nilVector3 = SCNVector3Make(0, 0, 0)
...
@objc class Vector: NSObject, VectorExport {
    ...
    convenience init(dictionary: NSDictionary) {
        let subscripts = ["vector", "Vector", "VECTOR"]
    ...
    init(name: String) {
        assertionFailure("Error: trying to initialize an Vector using strings; you probably wanted an Axis.")
    }
